...
public class SQLConnectionInfo {
    ...
    public SQLConnectionInfo(String folder, String database) {
    	Properties lproperties = null;
        Validate.notNull(folder, "folder cannot be null");
        Validate.notNull(database, "Database cannot be null");
        this.url = "jdbc:sqlite:" + folder + File.separator + database;
        this.properties = lproperties == null ? new Properties() : lproperties;
    }
